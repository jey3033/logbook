    ...
    return /******/ (() => {
        ...
        /******/ var __webpack_modules__ = {
            /***/ 9770: /***/ (
                ...
                jquery__WEBPACK_IMPORTED_MODULE_0___default().summernote =
        ...
        (() => {
            ...
            var external_jQuery_default =
                /*#__PURE__*/ __webpack_require__.n(external_jQuery_);
            // EXTERNAL MODULE: ./src/lang/summernote-en-US.js
            var summernote_en_US = __webpack_require__(9770); // CONCATENATED MODULE: ./src/js/core/env.js
            /**
            ...
            function validFontName(fontName) {
                return external_jQuery_default().inArray(
            ...
            function isEditable(node) {
                return (
                    node &&
                    external_jQuery_default()(node).hasClass("note-editable")
                );
            }
            /**
            ...
            function isControlSizing(node) {
                return (
                    node &&
                    external_jQuery_default()(node).hasClass(
                        "note-control-sizing"
                    )
                );
            }
            ...
            function isPara(node) {
                ...
                return (
                    node &&
                    /^DIV|^P|^LI|^H[1-7]/.test(node.nodeName.toUpperCase())
                );
            }
            ...
            function wrap(node, wrapperName) {
                ...
                var wrapper = external_jQuery_default()(
                    "<" + wrapperName + ">"
                )[0];
            ...
            function splitNode(point, options) {
                ...
                var isNotSplitEdgePoint =
                    options && options.isNotSplitEdgePoint;
            ...
            function html($node, isNewlineOnBlock) {
                ...
                if (isNewlineOnBlock) {
                    ...
                    markup = markup.replace(
                        regexTag,
                        function (match, endSlash, name) {
                            name = name.toUpperCase();
                            var isEndOfInlineContainer =
                                /^DIV|^TD|^TH|^P|^LI|^H[1-7]/.test(name) &&
                                !!endSlash;
                            var isBlockNode =
                            ...
                            return (
                                match +
                                (isEndOfInlineContainer || isBlockNode
                                    ? "\n"
                                    : "")
                            );
                        }
            ...
            var Context = /*#__PURE__*/ (function () {
                ...
                function Context($note, options) {
                    ...
                    external_jQuery_default().summernote.ui =
                        external_jQuery_default().summernote.ui_template(
                            this.options
                        );
                    ...
                    },
                    {
                        ...
                        value: function _initialize() {
                            ...
                            this.options.id = func.uniqueId(
                                external_jQuery_default().now()
                            ); // set default container for tooltips, popovers, and dialogs

                            this.options.container =
                                this.options.container ||
                                this.layoutInfo.editor; // add optional buttons

                            var buttons = external_jQuery_default().extend(
                                {},
                            ...
                            var modules = external_jQuery_default().extend(
                                {},
                                this.options.modules,
                                external_jQuery_default().summernote.plugins ||
                                    {}
                    ...
                    },
                    {
                        ...
                        value: function createInvokeHandler(namespace, value) {
                            ...
                            return function (event) {
                                ...
                                var $target = external_jQuery_default()(
                                    event.target
                                );
            ...
            external_jQuery_default().fn.extend({
                ...
                summernote: function summernote() {
                    var type = external_jQuery_default().type(
                        lists.head(arguments)
                    );
                    var isExternalAPICalled = type === "string";
                    var hasInitOptions = type === "object";
                    var options = external_jQuery_default().extend(
                        {},
                        external_jQuery_default().summernote.options,
                        hasInitOptions ? lists.head(arguments) : {}
                    ); // Update options

                    options.langInfo = external_jQuery_default().extend(
                        true,
                        {},
                        external_jQuery_default().summernote.lang["en-US"],
                        external_jQuery_default().summernote.lang[options.lang]
                    );
                    options.icons = external_jQuery_default().extend(
                        true,
                        {},
                        external_jQuery_default().summernote.options.icons,
                        options.icons
                    );
                    options.tooltip =
            ...
            function textRangeToPoint(textRange, isStart) {
                ...
                if (offset !== 0 && dom.isText(childNodes[offset - 1])) {
                    ...
                    textRangeStart.moveToElementText(
            ...
            function pointToTextRange(point) {
                var textRangeInfo = function textRangeInfo(container, offset) {
                    ...
                    if (dom.isText(container)) {
                        ...
                        var prevContainer =
                            lists.last(prevTextNodes).previousSibling;
                ...
                range_createClass(WrappedRange, [
                    ...
                    },
                    {
                        ...
                        value: function scrollIntoView(container) {
                            var height =
                                external_jQuery_default()(container).height();
                    ...
                    },
                    {
                        ...
                        value: function nodes(pred, options) {
                            ...
                            var fullyContains =
                                options && options.fullyContains; // TODO compare points and sort
                    ...
                    },
                    {
                        ...
                        value: function insertNode(node) {
                            ...
                            if (info.rightNode) {
                                info.rightNode.parentNode.insertBefore(
                                    node,
                                    info.rightNode
                                );

                                if (
                                    dom.isEmpty(info.rightNode) &&
                                    dom.isPara(node)
                                ) {
                                    info.rightNode.parentNode.removeChild(
                                        info.rightNode
                                    );
                                }
                            } else {
                    ...
                    },
                    {
                        ...
                        value: function pasteHTML(markup) {
                            ...
                            var contentsContainer =
                                external_jQuery_default()("<div></div>").html(
                                    markup
                                )[0];
                            var childNodes = lists.from(
                                contentsContainer.childNodes
                    ...
                    },
                    {
                        ...
                        value: function getWordRange(findAfter) {
                            ...
                            var startPoint = dom.prevPointUntil(
                                endPoint,
                                function (point) {
                    ...
                    },
                    {
                        ...
                        value: function getWordsRange(findAfter) {
                            ...
                            var isNotTextPoint = function isNotTextPoint(
                                point
                            ) {
                                return (
                                    !dom.isCharPoint(point) &&
                                    !dom.isSpacePoint(point)
                                );
                            };
            ...
            /* harmony default export */ const range = {
                ...
                createFromBodyElement: function createFromBodyElement(
                    bodyElement
                ) {
                 ...
                 * @return {WrappedRange}
                 */
                createFromBookmark: function createFromBookmark(
                    editable,
                    bookmark
                ) {
                ...
                createFromParaBookmark: function createFromParaBookmark(
                    ...
                    var so = bookmark.s.offset;
                    var eo = bookmark.e.offset;
                    var sc = dom.fromOffsetPath(
                        lists.head(paras),
                        bookmark.s.path
                    );
                    var ec = dom.fromOffsetPath(
                        lists.last(paras),
                        bookmark.e.path
                    );
                    return new WrappedRange(sc, so, ec, eo);
                ...
                Style_createClass(Style, [
                    ...
                    },
                    {
                        ...
                        value: function fromNode($node) {
                            ...
                            var styleInfo =
                                this.jQueryCSS($node, properties) || {};
                            var fontSize =
                                $node[0].style.fontSize ||
                                styleInfo["font-size"];
                    ...
                    },
                    {
                        ...
                        value: function stylePara(rng, styleInfo) {
                            external_jQuery_default().each(
                                ...
                                function (idx, para) {
                                    external_jQuery_default()(para).css(
                                        styleInfo
                                    );
                                }
                            );
                        ...
                        value: function styleNodes(rng, options) {
                            ...
                            if (expandClosestSibling) {
                                ...
                                return nodes.map(function (node) {
                                    var siblings = dom.withClosestSiblings(
                                        node,
                                        pred
                                    );
                    ...
                    },
                    {
                        ...
                        value: function current(rng) {
                            var $cont = external_jQuery_default()(
                                !dom.isElement(rng.sc)
                                    ? rng.sc.parentNode
                                    : rng.sc
                            );
                            ...
                            try {
                                styleInfo = external_jQuery_default().extend(
                                    styleInfo,
                                    {
                            ...
                            if (!rng.isOnList()) {
                                ...
                                var isUnordered =
                                    orderedTypes.indexOf(
                                        styleInfo["list-style-type"]
                                    ) > -1;
                            ...
                            styleInfo.ancestors = dom.listAncestor(
                                rng.sc,
                                dom.isEditable
                            );
                            styleInfo.range = rng;
                ...
                Bullet_createClass(Bullet, [
                        ...
                        value: function indent(editable) {
                            ...
                            external_jQuery_default().each(
                                ...
                                function (idx, paras) {
                                    ...
                                    if (dom.isLi(head)) {
                                        var previousList = _this.findList(
                                            head.previousSibling
                                        );

                                        if (previousList) {
                                            paras.map(function (para) {
                                                return previousList.appendChild(
                                                    para
                                                );
                                            });
                                        } else {
                            ...
                            if (lists.find(paras, dom.isPurePara)) {
                                ...
                                var diffLists = rng
                                    ...
                                    .filter(function (listNode) {
                                        return !external_jQuery_default().nodeName(
                                            listNode,
                                            listName
                                        );
                                    });
                    ...
                    },
                    {
                        ...
                        value: function wrapList(paras, listName) {
                            ...
                            var prevList =
                                dom.isList(head.previousSibling) &&
                                head.previousSibling;
                            var nextList =
                                dom.isList(last.nextSibling) &&
                                last.nextSibling;
                            var listNode =
                                prevList ||
                                dom.insertAfter(
                                    dom.create(listName || "UL"),
                                    last
                                ); // P to LI

                            paras = paras.map(function (para) {
                                return dom.isPurePara(para)
                                    ? dom.replace(para, "LI")
                                    : para;
                                    ...
                                    if (headList.parentNode.nodeName === "LI") {
                                        paras.map(function (para) {
                                            ...
                                            if (parentItem.nextSibling) {
                                                ...
                                                parentItem.parentNode.appendChild(
                                                    para
                                                );
                                            }
                                        ...
                                        if (
                                            ...
                                            parentItem.parentNode.removeChild(
                                                parentItem
                                            );
                                        }
                                    } else {
                                        ...
                                        paras = isEscapseToBody
                                            ...
                                            : lists
                                                  .from(middleList.childNodes)
                                                  .filter(dom.isLi); // LI to P

                                        if (
                                            isEscapseToBody ||
                                            !dom.isList(headList.parentNode)
                                        ) {
                                            paras = paras.map(function (para) {
                    ...
                    },
                    {
                        ...
                        value: function appendToPrevious(node) {
                            return node.previousSibling
                                ? dom.appendChildNodes(node.previousSibling, [
                                      node,
                                  ])
                        ...
                        value: function insertParagraph(editable, rng) {
                            ...
                            if (splitRoot) {
                                ...
                                if (
                                    ...
                                    this.bullet.toggleList(
                                        splitRoot.parentNode.nodeName
                                    );
                                    return;
                                } else {
                                    var blockquote = null;
                                    ...
                                    if (blockquote) {
                                        ...
                                        if (
                                            (dom.isHeading(nextPara) ||
                                                dom.isPre(nextPara) ||
                                                dom.isCustomStyleTag(
                                                    nextPara
                                                )) &&
                                            dom.isEmpty(nextPara)
                                        ) {
                                            nextPara = dom.replace(
                                                nextPara,
                                                "p"
                                            );
                                        }
            ...
            var TableResultAction = function TableResultAction(
                ...
                function addCellInfoToVirtual(row, cell) {
                    var cellIndex = recoverCellIndex(
                        row.rowIndex,
                        cell.cellIndex
                    );
                ...
                function getDeleteResultActionToCell(cell) {
                    switch (where) {
                        case TableResultAction.where.Column:
                            if (cell.isColSpan) {
                                return TableResultAction.resultAction
                                    .SubtractSpanCount;
                            }
                ...
                this.getActionList = function () {
                    ...
                    while (canContinue) {
                        var rowPosition =
                            fixedRow >= 0 ? fixedRow : actualPosition;
                        var colPosition =
                            fixedCol >= 0 ? fixedCol : actualPosition;
                        ...
                        var resultAction =
                            TableResultAction.resultAction.Ignore;
                ...
                Table_createClass(Table, [
                    {
                        ...
                        value:
                            ...
                            function tab(rng, isShift) {
                                var cell = dom.ancestor(
                                    rng.commonAncestor(),
                                    dom.isCell
                                );
                                var table = dom.ancestor(cell, dom.isTable);
                                var cells = dom.listDescendant(
                                    table,
                                    dom.isCell
                                );
                                var nextCell = lists[isShift ? "prev" : "next"](
                                    cells,
                                    cell
                                );
                    ...
                    },
                    {
                        ...
                        value: function addRow(rng, position) {
                            ...
                            var currentTr =
                                external_jQuery_default()(cell).closest("tr");
                            var trAttributes =
                                this.recoverAttributes(currentTr);
                            var html = external_jQuery_default()(
                                "<tr" + trAttributes + "></tr>"
                            );
                            var vTable = new TableResultAction(
                                ...
                                external_jQuery_default()(currentTr).closest(
                                    "table"
                                )[0]
                            );
                            ...
                            for (
                                ...
                                switch (currentCell.action) {
                                    ...
                                    case TableResultAction.resultAction
                                        .SumSpanCount:
                                        {
                                            if (position === "top") {
                                                var baseCellTr =
                                                    currentCell.baseCell.parent;
                                                var isTopFromRowSpan =
                                                    (!baseCellTr
                                                        ? 0
                                                        : currentCell.baseCell.closest(
                                                              "tr"
                                                          ).rowIndex) <=
                            ...
                            if (position === "top") {
                                ...
                                if (cellHasRowspan) {
                                    var lastTrIndex =
                                        ...
                                        (cell.rowSpan - 2);
                                    external_jQuery_default()(
                                        external_jQuery_default()(currentTr)
                                            .parent()
                                            .find("tr")[lastTrIndex]
                                    ).after(external_jQuery_default()(html));
                                    return;
                                }
                    ...
                    },
                    {
                        ...
                        value: function addCol(rng, position) {
                            ...
                            var row =
                                external_jQuery_default()(cell).closest("tr");
                            var rowsGroup =
                                external_jQuery_default()(row).siblings();
                            rowsGroup.push(row);
                            var vTable = new TableResultAction(
                                cell,
                                TableResultAction.where.Column,
                                TableResultAction.requestAction.Add,
                                external_jQuery_default()(row).closest(
                                    "table"
                                )[0]
                            );
                            var actions = vTable.getActionList();
                    ...
                    },
                    {
                        ...
                        value: function deleteRow(rng) {
                            ...
                            var cellPos = row
                                .children("td, th")
                                .index(external_jQuery_default()(cell));
                            ...
                            for (
                                ...
                                var virtualPosition =
                                    actions[actionIndex].virtualTable;
                                var hasRowspan =
                                ...
                                switch (actions[actionIndex].action) {
                                    ...
                                    case TableResultAction.resultAction
                                        ...
                                        if (hasRowspan) {
                                            if (rowspanNumber > 2) {
                                                rowspanNumber--;
                                                baseCell.setAttribute(
                                                    "rowSpan",
                                                    rowspanNumber
                                                );

                                                if (
                                                    virtualPosition.rowIndex !==
                                                        rowPos &&
                                                    baseCell.cellIndex ===
                                                        cellPos
                                                ) {
                    ...
                    },
                    {
                        ...
                        value: function createTable(
                            ...
                            trHTML = trs.join("");
                            var $table = external_jQuery_default()(
                                "<table>" + trHTML + "</table>"
                            );
            ...
            var Editor = /*#__PURE__*/ (function () {
                function Editor(context) {
                    ...
                    this.insertNode = this.wrapCommand(function (node) {
                        if (
                            _this.isLimited(
                                external_jQuery_default()(node).text().length
                            )
                        ) {
                            return;
                        }
                    ...
                    this.insertText = this.wrapCommand(function (text) {
                        ...
                        _this.setLastRange(
                            range
                                .create(textNode, dom.nodeLength(textNode))
                                .select()
                        );
                    });
                    /**
                    ...
                    this.pasteHTML = this.wrapCommand(function (markup) {
                        ...
                        _this.setLastRange(
                            range
                                .createFromNodeAfter(lists.last(contents))
                                .select()
                        );
                    });
                    /**
                    ...
                    this.createLink = this.wrapCommand(function (linkInfo) {
                        ...
                        external_jQuery_default().each(
                            anchors,
                            function (idx, anchor) {
                                external_jQuery_default()(anchor).attr(
                                    "href",
                                    linkUrl
                                );
                        ...
                        _this.setLastRange(
                            _this.createRangeFromList(anchors).select()
                        );
                    });
                    /**
                     * setting color
                    ...
                    this.removeMedia = this.wrapCommand(function () {
                        ...
                        if ($target.closest("figure").length) {
                            ...
                            $target = external_jQuery_default()(
                                _this.restoreTarget()
                            ).detach();
                        }
                ...
                Editor_createClass(Editor, [
                    {
                        ...
                        value: function initialize() {
                                ...
                                .on("keydown", function (event) {
                                    ...
                                    if (!event.isDefaultPrevented()) {
                                        if (_this2.options.shortcuts) {
                                            ...
                                            _this2.preventDefaultEditableShortCuts(
                                                event
                                            );
                                        }
                                    }
                            ...
                            this.$editable.html(
                                dom.html(this.$note) || dom.emptyPara
                            );
                            this.$editable.on(
                                env.inputEventName,
                    ...
                    },
                    {
                        ...
                        value: function createRangeFromList(lst) {
                            ...
                            var endRange = range.createFromNodeAfter(
                                lists.last(lst)
                            );
                            ...
                            if ($target && $target.length) {
                                ...
                                if ($target && $target.length) {
                                    ...
                                    var $parent = external_jQuery_default()([
                                        currentRange.sc,
                                        currentRange.ec,
                                    ]).closest(tagName); // remove class added for current block
                        ...
                        value: function fontStyling(target, value) {
                            ...
                            if (rng !== "") {
                                ...
                                this.$editor
                                    ...
                                    .html("");
                                external_jQuery_default()(spans).css(
                                    target,
                                    value
                                ...
                                if (rng.isCollapsed()) {
                                    ...
                                    if (
                                        firstSpan &&
                                        !dom.nodeLength(firstSpan)
                                    ) {
                                        firstSpan.innerHTML =
                                            dom.ZERO_WIDTH_NBSP_CHAR;
                                        range
                                            .createFromNode(
                    ...
                    },
                    {
                        ...
                        value: function getLinkInfo() {
                            ...
                            var $anchor = external_jQuery_default()(
            ...
            var Dropzone = /*#__PURE__*/ (function () {
                function Dropzone(context) {
                    ...
                    this.$dropzone = external_jQuery_default()(
                        [
                    ...
                    },
                    {
                        ...
                        value: function attachDragAndDropEvent() {
                            ...
                            this.documentEventHandlers.onDragenter = function (
                                ...
                                var isCodeview = _this.context.invoke(
                                    "codeview.isActivated"
                                );

                                var hasEditorSize =
                                    _this.$editor.width() > 0 &&
                                    _this.$editor.height() > 0;
                                ...
                                if (
                                    ...
                                    _this.$dropzone.width(
                                        _this.$editor.width()
                                    );

                                    _this.$dropzone.height(
                                        _this.$editor.height()
                                    );

                                    $dropzoneMessage.text(
                                        _this.lang.image.dragImageHere
                                    );
                                }
                            ...
                            this.$dropzone
                                .on("drop", function (event) {
                                    var dataTransfer =
                                        event.originalEvent.dataTransfer; // stop the browser from opening the dropped content
            ...
            function Codeview_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    Codeview_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
            ...
            function Statusbar_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    Statusbar_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
                ...
                Statusbar_createClass(Statusbar, [
                    {
                        ...
                        value: function initialize() {
                            ...
                            this.$statusbar.on("mousedown", function (event) {
                                ...
                                var editableTop =
                                    _this.$editable.offset().top -
                                    _this.$document.scrollTop();

                                var editableCodeTop =
                                    _this.$codable.offset().top -
                                    _this.$document.scrollTop();

                                var onMouseMove = function onMouseMove(event) {
                                    var height =
                                        event.clientY -
                                        (editableTop + EDITABLE_PADDING);
                                    var heightCode =
                                        event.clientY -
                                        (editableCodeTop + EDITABLE_PADDING);
                                    height =
                                        _this.options.minheight > 0
                                            ? Math.max(
                                                  height,
                                                  _this.options.minheight
                                              )
                                            : height;
                                    height =
            ...
            function Fullscreen_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    Fullscreen_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
            ...
            var Handle = /*#__PURE__*/ (function () {
                function Handle(context) {
                    ...
                    this.lang = this.options.langInfo;
                    this.events = {
                        "summernote.mousedown": function summernoteMousedown(
                            we,
                            e
                        ) {
                ...
                Handle_createClass(Handle, [
                    {
                        ...
                        value: function initialize() {
                            ...
                            this.$handle = external_jQuery_default()(
                                [
                    ...
                    },
                    {
                        ...
                        value: function update(target, event) {
                            ...
                            var $selection = this.$handle.find(
            ...
            function AutoLink_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    AutoLink_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
            ...
            var AutoLink = /*#__PURE__*/ (function () {
                function AutoLink(context) {
                    ...
                    this.events = {
                        ...
                        "summernote.keydown": function summernoteKeydown(
                            we,
                            e
                        ) {
                            ...
                            if (match && (match[1] || match[2])) {
                                ...
                                var urlText = this.options
                                    ...
                                    ? keyword
                                          ...
                                          .split("/")[0]
                                    : keyword;
                                var node = external_jQuery_default()("<a></a>")
                                    .html(urlText)
                                    .attr("href", link)[0];
            ...
            function AutoSync_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    AutoSync_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
            ...
            function AutoReplace_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    AutoReplace_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
            ...
            function Placeholder_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    Placeholder_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
                ...
                Placeholder_createClass(Placeholder, [
                    ...
                    },
                    {
                        ...
                        value: function initialize() {
                            ...
                            this.$placeholder = external_jQuery_default()(
                ...
                Buttons_createClass(Buttons, [
                    ...
                    },
                    {
                        ...
                        value: function addToolbarButtons() {
                                ...
                                return _this2.ui
                                    .buttonGroup([
                                        _this2.button({
                                            className: "dropdown-toggle",
                                            contents:
                                                _this2.ui.dropdownButtonContents(
                                                    _this2.ui.icon(
                                                        _this2.options.icons
                                                            .magic
                                                    ),
                                                    _this2.options
                                                ),
                            ...
                            for (
                                var styleIdx = 0,
                                    styleLen = this.options.styleTags.length;
                                styleIdx < styleLen;
                                styleIdx++
                            ) {
                            ...
                            this.context.memo("button.underline", function () {
                                return _this2
                                    .button({
                                        ...
                                        contents: _this2.ui.icon(
                                            _this2.options.icons.underline
                                        ),
                                        tooltip:
                                            _this2.lang.font.underline +
                                            _this2.representShortcut(
                                                "underline"
                                            ),
                                        click: _this2.context.createInvokeHandlerAndUpdateState(
                                            "editor.underline"
                            ...
                            this.context.memo("button.subscript", function () {
                                return _this2
                                    .button({
                                        ...
                                        contents: _this2.ui.icon(
                                            _this2.options.icons.subscript
                                        ),
                            ...
                            this.context.memo("button.fontname", function () {
                                var styleInfo = _this2.context.invoke(
                                    "editor.currentStyle"
                                );
                                ...
                                if (_this2.options.addDefaultFonts) {
                                    ...
                                    external_jQuery_default().each(
                                        ...
                                        function (idx, fontname) {
                                            ...
                                            if (
                                                _this2.isFontDeservedToAdd(
                                                    fontname
                                                )
                                            ) {
                                                if (
                                                    _this2.options.fontNames.indexOf(
                                                        fontname
                                                    ) === -1
                                                ) {
                                                    _this2.options.fontNames.push(
                                                        fontname
                                                    );
                                                }
                                            }
                                        ...
                                        .buttonGroup([
                                            ...
                                            _this2.ui.dropdownCheck({
                                                ...
                                                checkClassName:
                                                    _this2.options.icons
                                                        .menuCheck,
                                                items: _this2.options
                                                    .fontSizeUnits,
                                                title: _this2.lang.font
                                                    .sizeunit,
                                                click: _this2.context.createInvokeHandlerAndUpdateState(
                                                    "editor.fontSizeUnit"
                                                ),
                                ...
                                return _this2.ui
                                    .buttonGroup([
                                        _this2.button({
                                            ...
                                            tooltip:
                                                _this2.lang.paragraph.paragraph,
                                            data: {
                                                toggle: "dropdown",
                                            },
                                        }),
                            ...
                            this.context.memo("button.fullscreen", function () {
                                return _this2
                                    .button({
                                        ...
                                        contents: _this2.ui.icon(
                                            _this2.options.icons.arrowsAlt
                                        ),
                    ...
                    },
                    {
                        ...
                        value: function addImagePopoverButtons() {
                                ...
                                function () {
                                    return _this3
                                        .button({
                                            ...
                                            tooltip:
                                                _this3.lang.image.resizeQuarter,
                                            click: _this3.context.createInvokeHandler(
                                                "editor.resize",
                                                "0.25"
                                            ),
                            ...
                            this.context.memo("button.resizeNone", function () {
                                return _this3
                                    .button({
                                        contents: _this3.ui.icon(
                                            _this3.options.icons.rollback
                                        ),
                            ...
                            this.context.memo("button.floatLeft", function () {
                                return _this3
                                    .button({
                                        contents: _this3.ui.icon(
                                            _this3.options.icons.floatLeft
                                        ),
                            ...
                            this.context.memo("button.floatRight", function () {
                                return _this3
                                    .button({
                                        contents: _this3.ui.icon(
                                            _this3.options.icons.floatRight
                                        ),
                        ...
                        value: function addLinkPopoverButtons() {
                            ...
                            this.context.memo(
                                ...
                                function () {
                                    return _this4
                                        .button({
                                            contents: _this4.ui.icon(
                                                _this4.options.icons.link
                                            ),
                                            tooltip: _this4.lang.link.edit,
                                            click: _this4.context.createInvokeHandler(
                                                "linkDialog.show"
                                            ),
                                        })
                                        .render();
                        ...
                        value: function addTablePopoverButtons() {
                            ...
                            this.context.memo("button.addRowUp", function () {
                                return _this5
                                    .button({
                                        className: "btn-md",
                                        contents: _this5.ui.icon(
                                            _this5.options.icons.rowAbove
                                        ),
                            ...
                            this.context.memo("button.addColLeft", function () {
                                return _this5
                                    .button({
                                        className: "btn-md",
                                        contents: _this5.ui.icon(
                                            _this5.options.icons.colBefore
                                        ),
                            ...
                            this.context.memo("button.deleteRow", function () {
                                return _this5
                                    .button({
                                        className: "btn-md",
                                        contents: _this5.ui.icon(
                                            _this5.options.icons.rowRemove
                                        ),
                            ...
                            this.context.memo("button.deleteCol", function () {
                                return _this5
                                    .button({
                                        className: "btn-md",
                                        contents: _this5.ui.icon(
                                            _this5.options.icons.colRemove
                                        ),
                    ...
                    },
                    {
                        ...
                        value: function updateCurrentStyle($container) {
                            ...
                            var styleInfo = this.context.invoke(
                                "editor.currentStyle"
                            );
                            this.updateBtnStates($cont, {
                                ...
                                ".note-btn-underline":
                                    function noteBtnUnderline() {
                                        return (
                                            styleInfo["font-underline"] ===
                                            "underline"
                                        );
                                    },
                                ".note-btn-subscript":
                                    function noteBtnSubscript() {
                                        return (
                                            styleInfo["font-subscript"] ===
                                            "subscript"
                                        );
                                    },
                                ".note-btn-superscript":
                                    function noteBtnSuperscript() {
                                        return (
                                            styleInfo["font-superscript"] ===
                                            "superscript"
                                        );
                                    },
                            ...
                            if (styleInfo["font-family"]) {
                                ...
                                $cont
                                    ...
                                    .each(function (idx, item) {
                                        var $item =
                                            external_jQuery_default()(item); // always compare string to avoid creating another func.
                            ...
                            if (styleInfo["font-size"]) {
                                ...
                                $cont
                                    ...
                                    .each(function (idx, item) {
                                        var $item =
                                            external_jQuery_default()(item); // always compare with string to avoid creating another func.
                    ...
                    },
                    {
                        ...
                        value: function tableMoveHandler(event) {
                            var PX_PER_EM = 18;
                            var $picker = external_jQuery_default()(
                            ...
                            if (event.offsetX === undefined) {
                                var posCatcher = external_jQuery_default()(
                                    event.target
                                ).offset();
                                posOffset = {
                            ...
                            if (
                                dim.c > 3 &&
                                dim.c < this.options.insertTableMaxSize.col
                            ) {
                                $unhighlighted.css({
                                    width: dim.c + 1 + "em",
                                });
                            ...
                            if (
                                dim.r > 3 &&
                                dim.r < this.options.insertTableMaxSize.row
                            ) {
                                $unhighlighted.css({
                                    height: dim.r + 1 + "em",
                                });
                    ...
                    },
                    {
                        ...
                        value: function followScroll() {
                            ...
                            if (this.options.otherStaticBar) {
                                otherBarHeight = external_jQuery_default()(
                            ...
                            var editorOffsetBottom =
                                editorOffsetTop + editorHeight;
                            var activateOffset =
                            ...
                            if (
                                ...
                                currentOffset <
                                    deactivateOffsetBottom - toolbarHeight
                            ) {
            ...
            function LinkDialog_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    LinkDialog_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
                ...
                LinkDialog_createClass(LinkDialog, [
                        ...
                        value: function initialize() {
                            ...
                            var body = [
                                ...
                                !this.options.disableLinkTarget
                                    ? external_jQuery_default()("<div></div>")
                                          .append(
                                              this.ui
                                                  .checkbox({
                                                      className:
                    ...
                    },
                    {
                        ...
                        value: function showLinkDialog(linkInfo) {
                            ...
                            return external_jQuery_default()
                                .Deferred(function (deferred) {
                                    var $linkText =
                                        _this.$dialog.find(".note-link-text");

                                    var $linkUrl =
                                        _this.$dialog.find(".note-link-url");
                                            ...
                                            var isNewWindowChecked =
                                                ...
                                                undefined
                                                    ...
                                                    : _this.context.options
                                                          .linkTargetBlank;
                                            $openInNewWindow.prop(
                                                "checked",
                                                isNewWindowChecked
                                            );
                                            var useProtocolChecked =
                                                linkInfo.url
                                                    ? false
                                                    : _this.context.options
                                                          .useProtocol;
                    ...
                    },
                    {
                        ...
                        value: function show() {
                            ...
                            var linkInfo =
                                this.context.invoke("editor.getLinkInfo");
            ...
            function LinkPopover_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    LinkPopover_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
                ...
                function LinkPopover(context) {
                    ...
                    this.events = {
                        ...
                        "summernote.disable summernote.dialog.shown":
                            function summernoteDisableSummernoteDialogShown() {
                                _this.hide();
                            },
                    ...
                    },
                    {
                        ...
                        value: function update() {
                            ...
                            if (rng.isCollapsed() && rng.isOnAnchor()) {
                                ...
                                var containerOffset = external_jQuery_default()(
                                    this.options.container
                                ).offset();
            ...
            function ImageDialog_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    ImageDialog_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
                ...
                ImageDialog_createClass(ImageDialog, [
                    ...
                    },
                    {
                        ...
                        value: function showImageDialog() {
                            ...
                            return external_jQuery_default().Deferred(function (
                                deferred
                            ) {
                                var $imageInput =
                                    _this2.$dialog.find(".note-image-input");

                                var $imageUrl =
                                    _this2.$dialog.find(".note-image-url");

                                var $imageBtn =
                                    _this2.$dialog.find(".note-image-btn");

                                _this2.ui.onDialogShown(
                                    _this2.$dialog,
                                    function () {
                                        _this2.context.triggerEvent(
                                            "dialog.shown"
                ...
                ImagePopover_createClass(ImagePopover, [
                    ...
                    },
                    {
                        ...
                        value: function update(target, event) {
                            if (dom.isImg(target)) {
                                var position =
                                    external_jQuery_default()(target).offset();
                                var containerOffset = external_jQuery_default()(
                                    this.options.container
                                ).offset();
                                var pos = {};
            ...
            function VideoDialog_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                        ...
                        value: function createVideoNode(url) {
                            ...
                            if (ytMatch && ytMatch[1].length === 11) {
                                ...
                                if (typeof ytMatch[2] !== "undefined") {
                                    var ytMatchForStart =
                                        ytMatch[2].match(ytRegExpForStart);
                                ...
                                $video = external_jQuery_default()("<iframe>")
                                    .attr("frameborder", 0)
                                    .attr(
                                        "src",
                    ...
                    },
                    {
                        ...
                        value: function showVideoDialog() {
                            ...
                            return external_jQuery_default().Deferred(function (
                                ...
                                var $videoUrl =
                                    _this2.$dialog.find(".note-video-url");

                                var $videoBtn =
                                    _this2.$dialog.find(".note-video-btn");
            ...
            function HelpDialog_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    HelpDialog_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
            ...
            function AirPopover_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    AirPopover_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
                ...
                function AirPopover(context) {
                    ...
                    this.events = {
                        "summernote.contextmenu":
                            function summernoteContextmenu(e) {
            ...
            function HintPopover_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    HintPopover_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
                ...
                HintPopover_createClass(HintPopover, [
                    ...
                    },
                    {
                        ...
                        value: function moveDown() {
                            ...
                            if ($next.length) {
                                ...
                                if (!$nextGroup.length) {
                                    $nextGroup = this.$content
                                        .find(".note-hint-group")
                                        .first();
                                }

                                this.selectItem(
                                    $nextGroup.find(".note-hint-item").first()
                                );
                            }
                        },
                    },
                    {
                        ...
                        value: function moveUp() {
                            ...
                            if ($prev.length) {
                                ...
                                if (!$prevGroup.length) {
                                    $prevGroup = this.$content
                                        .find(".note-hint-group")
                                        .last();
                                }

                                this.selectItem(
                                    $prevGroup.find(".note-hint-item").last()
                                );
                            }
                        },
                    },
                            ...
                            if ($item.length) {
                                ...
                                if (
                                    ...
                                    this.lastWordRange.so =
                                        this.lastWordRange.eo; // Else si > 0 and normal case -> adjust range "before" for correct position of insertion
                                } else if (
                                    this.matchingWord !== null &&
                                    this.matchingWord.length > 0 &&
                                ...
                                if (this.options.hintSelect === "next") {
                                    ...
                                    external_jQuery_default()(node).after(
                                        blank
                                    );
                    ...
                    },
                    {
                        ...
                        value: function createItemTemplates(hintIdx, items) {
                            ...
                            return items.map(function (
                                ...
                                var $item = external_jQuery_default()(
                    ...
                    },
                    {
                        ...
                        value: function createGroup(idx, keyword) {
                            ...
                            var $group = external_jQuery_default()(
                            ...
                            this.searchKeyword(idx, keyword, function (items) {
                                ...
                                if (items.length) {
                                    $group.html(
                                        _this3.createItemTemplates(idx, items)
                                    );
                    ...
                    },
                    {
                        ...
                        value: function handleKeyup(e) {
                            ...
                            if (
                                ...
                                var _range = this.context.invoke(
                                    "editor.getLastRange"
                                );
            ...
            external_jQuery_default().summernote =
                external_jQuery_default().extend(
                    external_jQuery_default().summernote,
                    {
                        version: "0.8.20",
                        plugins: {},
                        ...
                        options: {
                            langInfo:
                                external_jQuery_default().summernote.lang[
                                    "en-US"
                                ],
                            editing: true,
                            modules: {
            ...
            function renderer_createClass(
                Constructor,
                protoProps,
                staticProps
            ) {
                if (protoProps)
                    renderer_defineProperties(
                        Constructor.prototype,
                        protoProps
                    );
                if (staticProps)
                ...
                renderer_createClass(Renderer, [
                    {
                        ...
                        value: function render($parent) {
                            ...
                            if (this.children) {
                                var $container = $node.find(
                                    ".note-children-container"
                                );
                                this.children.forEach(function (child) {
                                    child.render(
                                        $container.length ? $container : $node
                                    );
                                });
                            }
            ...
            function summernote_bs5_typeof(obj) {
                "@babel/helpers - typeof";
                if (
                    typeof Symbol === "function" &&
                    typeof Symbol.iterator === "symbol"
                ) {
                    summernote_bs5_typeof = function _typeof(obj) {
                        return typeof obj;
                    };
                } else {
                    summernote_bs5_typeof = function _typeof(obj) {
                ...
                return summernote_bs5_typeof(obj);
            }
                        ...
                        ? options.items
                              .map(function (item) {
                                  ...
                                  var content = options.template
                                      ...
                                      : item;
                                  var option =
                                      summernote_bs5_typeof(item) === "object"
                                          ? item.option
                                          : undefined;
            ...
            var dropdownButtonContents = function dropdownButtonContents(
                contents
            ) {
                return contents;
            };
            ...
            var summernote_bs5_checkbox = renderer.create(
                    ...
                    createLayout: function createLayout($note) {
                        var $editor = (
                            editorOptions.airMode
                                ? airEditor([
                                      editingArea([codable(), airEditable()]),
                                  ])
            ...
            external_jQuery_default().summernote.options.styleTags = [
                "p",
                {
                    title: "Blockquote",
                    tag: "blockquote",
